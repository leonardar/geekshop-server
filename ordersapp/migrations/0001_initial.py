# Generated by Django 3.2 on 2021-08-01 16:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен в обработку'), ('PD', 'оплачен'), ('PD', 'обрабатывается'), ('RDY', 'готов к выдаче'), ('CNL', 'отменен')], default='FM', max_length=3, verbose_name='статус')),
